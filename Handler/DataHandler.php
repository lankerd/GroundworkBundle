...
class DataHandler
{
    ...
    public function createRecord(Request $request)
    {
         ...
         * IMPORTANT NOTES
         * ===============
         * This needs to be dissolved down
         * into a more dynamic system where
         * a person can have nested queries that run.
         *
         * Should try to use the connector in order to recycle already
         * existing code.
         */
    ...
    /*Need to move this off to it's own file, and create the handleForm into a service*/
    public function handleForm(object $entity, array $data)
    {
        ...
        dump($this->dataHelper->getObjectProperties($entity));
        die;
        $form->remove('company');
        $form->setData($entity);
